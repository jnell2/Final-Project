...
if __name__ == '__main__':
    ...
    final.to_csv('~/Documents/DataScienceImmersive/Final-Project/data/final_EN.csv')
    finalLS.to_csv('~/Documents/DataScienceImmersive/Final-Project/data/finalLS_EN.csv')
